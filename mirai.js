...
console.log(chalk.bold.hex("#00FF00").bold("[ TANVIR 0.0.6 ] » ") + chalk.bold.hex("#00FF00").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`UmaruBot 9.7.5`, '[ tanvirahmed ]');
        logger('Hey, thank you for using this Bot', '[ tanvirahmed ]');
        logger("Fixed by Tanvir Ahmed", '[ tanvirahmed ]');
        logger("FB: https://www.facebook.com/T4NV1R.BR4ND.Y0UR.N3X7.D4D", 'Fixed by TANVIR Ahmed');
