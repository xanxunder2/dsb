...
module.exports.run = async ({ api, event}) => {
   const { threadID, messageID, senderID } = event;
    ...
    const gai = ["বিদ্বানের কলমের কালি শহীদের রক্তের চেয়েও পবিত্র ।— আল হাদিস",

      "সৎ লোক সবার বিপদে পড়লে আবার উঠে কিন্তু অসৎ লোক বিপদে পড়লে একবারে নিপাত যায় ।— হযরত সুলাইমান (আঃ)"
    ];
    const trai = ["সৎ লোক সবার বিপদে পড়লে আবার উঠে কিন্তু অসৎ লোক বিপদে পড়লে একবারে নিপাত যায় ।— হযরত সুলাইমান (আঃ).",
