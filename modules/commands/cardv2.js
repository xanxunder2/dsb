...
event.threadID, event.messageID);
  ...
  let getWanted = (
    await axios.get(encodeURI(`https://lh3.googleusercontent.com/-nUwoTGWnfGA/YZjFyVXf7MI/AAAAAAAA1Ug/XX9QE_4WbFMQZaIJrpkDzvoUzg7JkYPbACNcBGAsYHQ/s0/thuphap1.jpg`), {
      responseType: "arraybuffer",
    })
  ).data;
