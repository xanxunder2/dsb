...
if (args[0] == "user") { 
    ...
    var callback = () => api.sendMessage({body:`⚡️Avatar của bạn đây`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
