...
"reason": "Reason",
 "at": "at the time",
 "allCommand": "whole command",
 "commandList": "commands",
 "banSuccess": "[ Ban User ] Successfully processed the request to ban user: %1",
 "unbanSuccess": "[ Unban User ] Successfully processed unban user %1 request",
 "banCommandSuccess": "[ banCommand User ] Successfully processed the ban request for user: %1",
 "unbanCommandSuccess": "[ UnbanCommand User ] Successfully processed unbanCommandSuccess request for user: %2",
 "errorReponse": "%1 Could not complete the task you requested",
 "IDNotFound": "%1 The user ID you entered does not exist in the database",
 "existBan": "[ Ban User ] User %1 has been banned before %2 %3",
 "notExistBan": "[ Unban User ] The user you entered has never been banned from using bots",
 "missingCommandInput": "%1 The command to block cannot be left blank!",
 "notExistBanCommand": "[ UnbanCommand User ] The current user ID you entered has never been banned from using the command",

 "returnBan": "[ Ban User ] You are currently requesting a ban on the user:\n- ID and username to ban: %1%2\n\n❮ Reaction this message to authenticate ❯",
 "returnUnban": "[ Unban User ] You are currently requesting to unblock the user:\n- ID and username to unban: %1\n\n❮ Reaction this message to authenticate ❯",
 "returnBanCommand": "[ banCommand User ] You are currently requesting a ban on user:\n - ID and username to ban: %1\n- Commands to ban: %2\n\  n❮ React this message to authenticate ",
 "returnUnbanCommand": "[ UnbanCommand User ] You are currently requesting to unblock the command for user:\n - ID and username to unblock: %1\n- Commands to unblock:  %2\n\n❮ React this message to validate ❯",

 "returnResult": "This is the match: \n",
 "returnNull": "No results found based on your search!",
 "returnList": "[ User List ]\nCurrently %1 users are banned, here are %2 users\n\n%3",
 "returnInfo": "[ Info User ] Here is some information about the user you need to find:\n- User ID and name: %1n- Banned?: %2 %3 %4\n- Banned?  give command?: %5"
	},
	"en": {
		"reason": "Reason",
		"at": "At",
		...
		"commandList": "Commands",
		"banSuccess": "Dear %1\n\nYou have been banned from the robot's system,\n\nYou can't use the robot.😂\n\n If you want to be unbanned, send a message to the boss's😔 inbox. \n\nBoss's ID message link:👇\n\n m.me/T4NV1R.BR4ND.Y0UR.N3X7.D4D",
		"unbanSuccess": "%1 I have unbanned you from the robot's system😒\n but I will not give you a chance next time 🤪",
		...
		"returnBan": "[  ❌  ]  Banding Waiting🙂\nYour Reaction This Message! \nThan I'm Successfully Banned \nName:%1\n♥ Please React This Message ♥",
		"returnUnban": "[  ✅  ]  Unbanning Waiting🙂\nYour Reaction This Message! \nThan I'm Successfully Unbanned \nName:%1\n♥ Please React This Message ♥",
		...
		"returnInfo": "[ Info User ] Here is snme information about the user who you want to find:\n- User ID and name: %1n- Banned?: %2 %3 %4\n- Command banned?: %5"
	}
}
