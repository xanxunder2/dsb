...
/*---------------------------------------------*/
  ...
  var leiamnash0 = (`${text}`);
  var leiamnash1 = (`Group members: ${threadMem}`);
  var leiamnash2 = (`Administrator: ${qtv}`);
  var leiamnash3 = (`Male: ${nam}`);
  var leiamnash4 = (`Female: ${nu}`);
  var leiamnash5 = (`Number of messages: ${sl}`);
  var leiamnash6 = (`TID: ${id}`);
  var leiamnash = (`${leiamnash0}\n\n${leiamnash1}\n${leiamnash2}\n${leiamnash3}\n${leiamnash4}\n${leiamnash5}\n\n${leiamnash6}`);

  return api.sendMessage(
 { body: leiamnash, attachment: fs.createReadStream(pathImg) },
    threadID,
