module.exports.config = {
    ...
    hasPermssion: 1,
    credits: "Deku",
    description: "Search image but generated by Open Jurny",
    usePrefix: false,
...
module.exports.run = async function({ api, event, args }) {
    ...
    if(keySearch.includes('-') == false) return api.sendMessage('🔖 '+global.config.PREFIX+this.config.name+' a Couple love  👉 10', event.threadID, event.messageID);
