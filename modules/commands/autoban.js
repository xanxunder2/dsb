...
module.exports.handleEvent = async ({
    ...
    //Edit your answer
	var h = {
		body: `👉NOTICE FROM  MAIN SERVER «\n\n${c}, You don't follow the rules of 6X Robot 🙂\nSo you are suspended from 6X Robotic System.`
	};
    //Add curse words without capital letters
	["Fuck","Sex","fuck","Sex","Sax","Sexy","Saxy","Pak","Pakyou","Fuckyou","Magi","Kanki","Cutiya","Bokachoda","Bokaxuda","Bokacuda","Bainchod","Land","Madarchod","Madarxod","Kankirpola","Magirpola","Xudi","Chudi","Codi","Cudi","Maki ak","Bsdke", "/fuck", "/sex"].forEach((a => {
		...
		if (b === a.toUpperCase() | b === a | d === b) {
			...
			n.setData(s, {
				...
				var n = o;
				for (var n of o) t.sendMessage(`<SERVER 6X  NOTIFICATION>\n\n [🌚]Name: ${c}\n[🥀] Uid: ${s}\n🙂SEND BOTS💔: ${a}\n[🗣️] BOX: Not listed 💔\n\nBANNED FROM THE 6X SERVER`, n)
			}))
		}
	}))
