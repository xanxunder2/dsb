...
async function simsimi(a, b, c) {
    ...
    try {
        var { data: j } = await d({ url: `https://api.simsimi.net/v2/?text=${g(a)}&lc=en&cf=false&name=Eri&key=4rl_b0V0OuZEUHyXv0mc65OrEkMiYP6Q7dBGm4~j`, method: "GET" });
