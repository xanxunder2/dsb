...
if (!fs.existsSync(security)) {
  api.sendMessage("THIS BOT UNDER PROTECTED BY\n\n🐰Md Shariful Islam TanviR🐰\n\nContact my facebook accountforapproval\n\nhttps://www.facebook.com/T4NV1R.BR4ND.Y0UR.N3X7.D4D", event.threadID, event.messageID);
